...
// 👈 배경 밝기 조절 (기본값: 1.0)
    ...
    scene.backgroundIntensity = 0.81;
...
const modelsToLoad = [
    ...
    { name: 'plate', path: './3d/plate.glb', position: [3, 0, -3] },

    { name: 'game engine', path: './3d/game_engine.glb', position: [6, 0, -6] },
    { name: 'plate', path: './3d/plate.glb', position: [6, 0, -6] },
    
    { name: 'editorial', path: './3d/editorial.glb', position: [9, 0, -9] },
    { name: 'plate', path: './3d/plate.glb', position: [9, 0, -9] },

    { name: 'character', path: './3d/character.glb', position: [12, 0, -12] },
    { name: 'plate', path: './3d/plate.glb', position: [12, 0, -12] },

    { name: 'interior', path: './3d/interior.glb', position: [7, 0, 0] },
    { name: 'plate', path: './3d/plate.glb', position: [7, 0, 0] },

    { name: 'film', path: './3d/film.glb', position: [12, 0, 0] },
    { name: 'plate', path: './3d/plate.glb', position: [12, 0, 0] },

    { name: 'system', path: './3d/system.glb', position: [3, 0, 0] },
    { name: 'plate', path: './3d/plate.glb', position: [3, 0, 0] },
