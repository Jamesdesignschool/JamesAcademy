...
(function () {
    ...
    img.style.cssText = "position:fixed; bottom:30px; left:50%; transform:translateX(-50%); width:140px; height:64px; opacity:1; z-index:9999; pointer-events:none; transition:opacity 0.3s ease;";
    document.body.appendChild(img);
})();
...
const modelsToLoad = [
    ...
    { name: 'system', path: './3d/system.glb', position:                 [0, 0, -35] },
    { name: 'plate', path: './3d/plate.glb', position:                   [0, 0, -35] },
