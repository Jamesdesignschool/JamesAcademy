...
controls.enableZoom = true;         // 두 손가락 핀치 줌 활성화
controls.zoomSpeed = 1.5;           // 줌 속도

controls.enablePan = true;          // 두 손가락 패닝 활성화
controls.panSpeed = 13.8;

controls.minDistance = 2;           // 최소 거리 제한
controls.maxDistance = 50;          // 최대 거리 제한
...
// 1. 컨트롤 설정
controls.enableDamping = true;      // 부드러운 움직임 (필수)
controls.dampingFactor = 0.05;

// 1. 줌 활성화 (두 손가락 핀치 줌)
controls.enableZoom = true;         
controls.zoomSpeed = 1.5;           // 모바일에서는 조금 더 빠르게 설정하면 시원시원합니다.

// 2. 패닝 활성화 (두 손가락으로 위치 이동)
controls.enablePan
controls.screenSpacePanning = true;
controls.panSpeed = 2.8;                                                    // << -- 패팅 스피드

// 3. 거리 제한 (선택 사항: 모델을 뚫고 들어가거나 너무 멀어지는 것 방지)
controls.minDistance = 2;           
controls.maxDistance = 50;

controls.target.set(0, 0.9, 2);     // 초기 타겟 설정
